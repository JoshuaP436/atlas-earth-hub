...
export function SocialLoginButton({ provider, isLoading, onLoading }: SocialLoginButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className={`
        w-full flex items-center justify-center px-4 py-2 border rounded-md shadow-sm text-sm font-medium
